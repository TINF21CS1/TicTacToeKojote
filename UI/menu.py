...
class Menu(base_frame):
    ...
    def _create_widgets(self):
        ...
        self.btnField = tk.Button(self, width=20, height=5, text='Play / Start Lobby', command=lambda: self.master.show(Lobby))
        ...
        self.btnConnect = tk.Button(self, text="Connect", command=lambda: self.master.show(Lobby))
    ...
    def _display_widgets(self):
        ...
        self.btnField.grid(sticky=tk.E+tk.W, column=3, row=0, columnspan=5)#pack(fill=tk.Y, expand=True)
        self.btnMulti.grid(sticky=tk.E+tk.W, column=3, row=1, columnspan=5)#pack(fill=tk.Y, expand=True)
        self.btnStats.grid(sticky=tk.E+tk.W, column=3, row=3, columnspan=5)#pack(fill=tk.Y, expand=True)
        self.btnExit.grid(sticky=tk.E+tk.W, column=3, row=4, columnspan=5)#pack(fill=tk.Y, expand=True)
